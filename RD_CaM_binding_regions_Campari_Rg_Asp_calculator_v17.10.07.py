...
This script formats Campari trajectorys (from a PDB format) into a custom format. The script calculates the Radius of Gyration (Rg) and Asphericity (Asp) of a range of residues within the larger protein.
...
for file in files:
    ...
    for line in specificfile:
        ...
        if "ATOM" in line:
            ...
            if appendage[1] >startResidue and appendage[1] < endResidue:  
